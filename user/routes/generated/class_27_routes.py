...
"""
Auto-generated routes for Class: Networking 3 (ID: 27)
Generated on: 2025-07-06 20:53:27
"""
...
def class_home():
    """Main class page"""
    class_obj = Class.query.get_or_404(27)
    ...
    template_data = {
        ...
        'data': data,
        'modules': get_class_modules(27),
        'simulations': get_class_simulations(27),
        'question_groups': get_class_question_groups(27),
        'user_progress': get_user_progress(user_id, 27) if user_id else None,
        'user_context': user_context
    }
    
    return render_template(
        'user/classes/class_27_2eju6t.html',
        **template_data
    )

@class_27_bp.route('/module/<int:module_id>')
@flexible_login_required
...
@class_27_bp.route('/lesson/<int:lesson_id>')
@flexible_login_required
...
@class_27_bp.route('/simulation/<simulation_id>')
@flexible_login_required
...
@class_27_bp.route('/assessment/<int:assessment_id>')
@flexible_login_required
...
@class_27_bp.route('/api/lesson/<int:lesson_id>')
@flexible_login_required
...
@class_27_bp.route('/api/progress')
@flexible_login_required
def api_get_progress():
    """API endpoint to get user progress"""
    user_context = get_current_user_context()
    user_id = user_context['user_id']
    progress = get_user_progress(user_id, 27)
    
    return jsonify(progress)

@class_27_bp.route('/api/submit-answer', methods=['POST'])
@flexible_login_required

...
"""
Auto-generated routes for Class: Networking (ID: 26)
Generated on: 2025-07-06 18:52:12
"""
...
def class_home():
    """Main class page"""
    class_obj = Class.query.get_or_404(26)
    ...
    template_data = {
        ...
        'data': data,
        'modules': get_class_modules(26),
        'simulations': get_class_simulations(26),
        'question_groups': get_class_question_groups(26),
        'user_progress': get_user_progress(user_id, 26) if user_id else None,
        'user_context': user_context
    }
    
    return render_template(
        'user/classes/class_26_qrdb2w.html',
        **template_data
    )

@class_26_bp.route('/module/<int:module_id>')
@flexible_login_required
...
@class_26_bp.route('/lesson/<int:lesson_id>')
@flexible_login_required
...
@class_26_bp.route('/simulation/<simulation_id>')
@flexible_login_required
...
@class_26_bp.route('/assessment/<int:assessment_id>')
@flexible_login_required
...
@class_26_bp.route('/api/lesson/<int:lesson_id>')
@flexible_login_required
...
@class_26_bp.route('/api/progress')
@flexible_login_required
def api_get_progress():
    ...
    progress = get_user_progress(user_id, 26)
    
    return jsonify(progress)

@class_26_bp.route('/api/submit-answer', methods=['POST'])
@flexible_login_required

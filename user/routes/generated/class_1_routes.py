...
"""
Auto-generated routes for Class: Introduction to Networking (ID: 1)
Generated on: 2025-07-06 18:42:33
"""
...
def class_home():
    """Main class page"""
    class_obj = Class.query.get_or_404(1)
    ...
    template_data = {
        ...
        'data': data,
        'modules': get_class_modules(1),
        'simulations': get_class_simulations(1),
        'question_groups': get_class_question_groups(1),
        'user_progress': get_user_progress(user_id, 1) if user_id else None,
        'user_context': user_context
    }
    
    return render_template(
        'user/classes/class_1_net101.html',
        **template_data
    )

@class_1_bp.route('/module/<int:module_id>')
@flexible_login_required
...
@class_1_bp.route('/lesson/<int:lesson_id>')
@flexible_login_required
...
@class_1_bp.route('/simulation/<simulation_id>')
@flexible_login_required
...
@class_1_bp.route('/assessment/<int:assessment_id>')
@flexible_login_required
...
@class_1_bp.route('/api/lesson/<int:lesson_id>')
@flexible_login_required
...
@class_1_bp.route('/api/submit-answer', methods=['POST'])
@flexible_login_required
...
@class_1_bp.route('/simulation/components')
@flexible_login_required

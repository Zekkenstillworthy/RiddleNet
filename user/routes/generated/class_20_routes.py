...
"""
Auto-generated routes for Class: Network (ID: 20)
Generated on: 2025-07-07 01:00:44
"""
...
def class_home():
    """Main class page"""
    class_obj = Class.query.get_or_404(20)
    ...
    template_data = {
        ...
        'data': {
            ...
            'modules': get_class_modules(20)
        },
        'modules': get_class_modules(20),
        'simulations': get_class_simulations(20),
        'question_groups': get_class_question_groups(20),
        'user_progress': get_user_progress(user_id, 20) if user_id else None,
        'user_context': user_context
    }
    
    return render_template(
        'user/classes/class_20_b88kyb.html',
        **template_data
    )

@class_20_bp.route('/module/<int:module_id>')
@flexible_login_required
...
@class_20_bp.route('/lesson/<int:lesson_id>')
@flexible_login_required
...
@class_20_bp.route('/simulation/<simulation_id>')
@flexible_login_required
...
@class_20_bp.route('/assessment/<int:assessment_id>')
@flexible_login_required
...
@class_20_bp.route('/api/lesson/<int:lesson_id>')
@flexible_login_required
...
@class_20_bp.route('/api/progress')
@flexible_login_required
def api_get_progress():
    """API endpoint to get user progress"""
    user_context = get_current_user_context()
    user_id = user_context['user_id']
    progress = get_user_progress(user_id, 20)
    
    return jsonify(progress)

@class_20_bp.route('/api/submit-answer', methods=['POST'])
@flexible_login_required

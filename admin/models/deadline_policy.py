...
class StudentDeadlineExtension(db.Model):
    ...
    approved_by = db.Column(db.Integer, db.ForeignKey('admin_users.id'), nullable=False)
    ...
    approver = db.relationship('AdminUser', foreign_keys=[approved_by], backref='granted_extensions')

...
class AssignmentSubmission(db.Model):
    ...
    graded_by = db.Column(db.Integer, db.ForeignKey('admin_users.id'), nullable=True)
    ...
    grader = db.relationship('AdminUser', foreign_keys=[graded_by], backref='graded_submissions')
...
class AssignmentSubmissionHistory(db.Model):
    ...
    # Who made the change
    changed_by = db.Column(db.Integer, nullable=False)  # User ID (student or admin)
    changed_by_type = db.Column(db.String(10), nullable=False)  # 'student' or 'admin'

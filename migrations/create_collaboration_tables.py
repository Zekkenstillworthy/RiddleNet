#!/usr/bin/env python3
"""
Migration script to create collaboration tables for the collaboration system
"""
...
def create_collaboration_tables():
    """Create collaboration_settings, collaboration_lobbies, and team_assignments tables"""
    app = create_app()

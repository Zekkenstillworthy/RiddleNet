...
topology_bp = Blueprint('topology', __name__, url_prefix='/instructor/topology')
...
def topology_features_guide():
    ...
    return render_template('instructor/topology_features_guide.html')
...
def topology_management():
    ...
    from flask import render_template
    return render_template('instructor/topology_management.html')

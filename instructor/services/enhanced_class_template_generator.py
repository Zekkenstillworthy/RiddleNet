...
class EnhancedClassTemplateGenerator(ClassTemplateGenerator):
    ...
    def _generate_general_template(self, data: Dict[str, Any]) -> str:
        ...
        template = f'''
{{% if user_context and user_context.get('is_instructor') %}}
    ...
    <div class="learning-header">
      <div>
        ...
        <p class="page-subtitle">Interactive Class Portal & Learning Environment
          {{% if user_context and user_context.get('is_instructor') %}}
          <span class="instructor-badge">instructor View</span>
          {{% endif %}}
        </p>
      </div>
      <div>
        {{% if user_context and user_context.get('is_instructor') %}}
        <a href="/admin/classes" class="back-to-instructor">
          <i class="fas fa-arrow-left"></i>
          Back to Instructor
        </a>
        {{% else %}}
        <a href="/user/classes" class="back-to-instructor">
          <i class="fas fa-arrow-left"></i>
          Back to Classes
        </a>
        {{% endif %}}
        ...
        <div class="content-grid">
          ...
          <div class="content-card">
            ...
            <p class="card-description">
              This class is ready for content! Use the instructor Panel to create modules and lessons.
            </p>
            {{% if user_context and user_context.get('is_instructor') %}}
      ...
      <div id="assessments-tab" class="tab-content">
        <div class="content-grid">
          ...
          <div class="content-card">
            ...
            <p class="card-description">
              No assessments have been created yet. Use the instructor Panel to add Quiz and assessments.
            </p>
            {{% if user_context and user_context.get('is_instructor') %}}

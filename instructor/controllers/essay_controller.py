...
def index():
    ...
    if step == 'classes':
        ...
        return render_template('instructor/essays_enhanced.html',
                             step='classes',
...
def users():
    ...
    return render_template('instructor/user_essays.html',
...
def view(essay_id):
    ...
    return render_template('instructor/essay_detail.html', 
                           essay=essay, 
                           user=user,
                           active_page='essays')

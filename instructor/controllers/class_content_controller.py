...
def manage_content(class_id):
    ...
    try:
        ...
        return render_template('instructor/class_content_manager.html',
                             class_data=cls,
                             selected_class=cls,
...
def preview_module_page(class_id, module_id):
    ...
    try:
        ...
        template_name = 'instructor/module_preview.html'
...
def get_module_preview_html(class_id, module_id):
    ...
    try:
        ...
        html_content = render_template('instructor/module_preview_template.html',
                                     class_name=cls.name,
                                     class_data=cls,
                                     module=module,
                                     lessons=lessons,

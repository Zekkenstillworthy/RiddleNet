...
def index():
    ...
    try:
        ...
        return render_safe_template('instructor/lessons/enhanced_editor.html',
                                   lessons=lessons,
                                   classes=classes,
...
def view_lesson(lesson_id):
    ...
    try:
        ...
        return render_safe_template('instructor/lessons/detail.html',
                                   lesson=lesson,
                                   stats=stats,
...
def new_lesson(class_id, module_id):
    ...
    try:
        ...
        return render_safe_template('instructor/lessons/form.html',
                                   class_obj=class_obj,
                                   module=module,
                                   lesson=None,

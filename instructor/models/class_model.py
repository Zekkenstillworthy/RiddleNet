...
class Class(db.Model):
    ...
    # Ownership: which instructor created/owns this class
    created_by = db.Column(db.Integer, db.ForeignKey('instructor.id'), nullable=True)

    # Optional relationship to the Instructor who created the class. Use string import to avoid circular import.
    creator = db.relationship('Instructor', backref=db.backref('created_classes', lazy='dynamic'), foreign_keys=[created_by])

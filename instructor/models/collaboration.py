...
class CollaborationSetting(db.Model):
    ...
    created_by_instructor = db.relationship('Instructor', backref='collaboration_settings')
...
class TeamAssignment(db.Model):
    ...
    created_by_instructor = db.relationship('Instructor', backref='team_assignments')

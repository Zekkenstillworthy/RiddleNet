...
class NotificationHistory(db.Model):
    ...
    sender_type = db.Column(db.String(20), nullable=False)  # 'instructor' or 'user'
        ...
        while retry_count < max_retries:
            try:
                ...
                record = cls(
                    ...
                    notification_type=notification_data.get('notification_type', 'instructor_notice'),
            ...
            for n in notifications:
                try:
                    ...
                    result.append({
                        ...
                        'type': getattr(n, 'notification_type', 'instructor_notice'),
